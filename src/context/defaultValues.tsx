...
import { ALL_CATEGORY_ID, FORM_MODES, FormMode } from "../utils/constants";
...
export const DEFAULT_WEBSITE_FORM_MODE: FormMode = FORM_MODES.CREATE;
export const DEFAULT_CATEGORY_FORM_MODE: FormMode = FORM_MODES.CREATE;
